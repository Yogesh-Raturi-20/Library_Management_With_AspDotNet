<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="admin-publisher-management.aspx.cs" Inherits="LibraryManagement.admin_publisher_management" %>
                         ...
                         <div class="row">
                              <div class="col-md-4">
                               ...
                               <div class="form-group">
                                   ...
                                   <asp:TextBox CssClass="form-control form-control-lg" ID="txt_PublisherId" runat="server" placeholder="ID" ></asp:TextBox>
                            ...
                            <div class="col-md-8">
                               ...
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control form-control-lg" ID="txt_PublisherName" runat="server" placeholder=" Name"></asp:TextBox>
                               </div>
                            </div>
                        </div>
                         <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            ...
                            <div class="col">
                                <asp:GridView CssClass="table table-striped table-bordered" ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="publisher_id">
                                    <Columns>
