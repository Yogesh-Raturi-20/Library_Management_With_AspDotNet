...
namespace LibraryManagement
{
    public partial class MyCaptcha : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Brush designBrush = default(Brush);
            // Captcha Background Design 
            ...
            //create captcha rectungular area for ui
            RectangleF rectangleArea = new RectangleF(0, 0, 250, 250);
            designBrush = new HatchBrush(bkgStyle[random.Next(bkgStyle.Length - 3)], Color.FromArgb((random.Next(100, 255)), (random.Next(100, 255)), (random.Next(100, 255))), Color.White);
            ...
            //add captcha code into session  for use
