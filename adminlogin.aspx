                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center>
                                    <img width="150px" src="Images/admin%20user.png" />
                                </center>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                               ...
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control form-control-lg" ID="txt_AdminId" runat="server" placeholder=" Enter ID" ></asp:TextBox>
                                   <center>
                         ...
                         <div class="row">
                            <div class="col">
                               ...
                               <div class="form-group">
                                   <asp:TextBox CssClass="form-control form-control-lg" ID="txt_Password" runat="server" placeholder=" Enter Password" TextMode="Password"></asp:TextBox>
                                   <center>
